...
- Bitcoin reserve proof remains pending until a public BTC address, on-chain balance, and signed proof are published.
...
- Bitcoin reserve should stay described as planned or pending until address and signed proof are published.
