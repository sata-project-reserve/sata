...
const SAFE_NPM_SCRIPTS = new Set([
  ...
  'ops:outreach-contact-evidence-plan',
  ...
  'ops:referral-handoff-evidence-plan',
  'ops:referral-handoff-response-evidence-check',
  'ops:referral-handoff-response-evidence-plan',
  'ops:reserve-check',
  'ops:reserve-plan',
  'ops:reply-conversion-check',
  'ops:reply-conversion-markdown',
  'ops:reply-conversion-plan',
  'ops:inbound-reply-triage-check',
  'ops:inbound-reply-triage-plan',
  'ops:revenue-check',
  'ops:revenue-plan',
  'ops:sats-check',
  'ops:sats-plan',
